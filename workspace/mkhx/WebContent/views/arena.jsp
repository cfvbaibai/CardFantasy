    ...
    <div id="arena" data-role="page" data-title="战场" data-mini="true" class="fixed-width">
        ...
        <div data-role="content" data-theme="c">
            ...
            <div id="video-content-panel" style="display: none">
                ...
                <textarea id="video-content" style="height: 200px; width: 98%; overflow-y: auto; word-wrap: break-word; margin-left: auto; margin-right: auto; font-size: 9px">
                </textarea>
            ...
            <div id="arena-control-panel" data-mini="true" data-role="controlgroup" data-type="horizontal">
                ...
                <a id="save-video-button" data-role="button" data-mini="true" data-theme="c">保存</a>
                <a id="report-bug-button" data-role="button" data-mini="true" data-theme="c" data-type="bug" href="#">提BUG</a>
            </div>
