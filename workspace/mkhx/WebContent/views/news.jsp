            ...
            <div data-role="collapsible" data-collapsed="false" data-mini="true">
                ...
                <ul class="news-content">
                    ...
                    <li>2016-5-27: <ul>
                        ...
                        <li>添加网页版新卡<cf:c>鲁纳斯歌者</cf:c>，感谢<x>游天使</x>的帮助</li>
                    </ul></li>
                    <li>2016-5-22: <ul>
                    ...
                    <li>2016-2-26: <ul>
                        ...
                        <li>添加网页版新卡<cf:c>黄金狮子</cf:c>，感谢<x>我去页游大爷的</x>的帮助</li>
                        <li>添加新卡<cf:c>森林之主</cf:c>，感谢<x>希灵天使12345</x>的帮助</li>
                        <li>添加网页版新卡<cf:c>全知灵龙</cf:c>，感谢<x>xinkai_001</x>和<x>苍真在天</x>的帮助</li>
                    ...
                    <li>2016-2-7: <ul>
                        ...
                        <li>添加网页版新卡<cf:c>弑神之刃</cf:c>, 感谢<x>xinkai_001</x>提供的数据</li>
                    </ul></li>
