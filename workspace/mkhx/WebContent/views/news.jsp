            ...
            <div data-role="collapsible" data-collapsed="false" data-mini="true" data-content-theme="d" data-theme="c">
                ...
                <ul class="news-content">
                    ...
                    <li>2015-09-26: <ul>
                        ...
                        <li>补上<c>炎魔</c>、<c>投掷巨人</c>、<c>鬼符咒术师</c>、<c>恐怖失血者</c>和<c>复仇铠甲</c>的卡图，感谢<x>御洛念</x>和<x>咬起来喀嚓喀嚓</x>提供的卡图</li>
                        <li>加强了【<a href="#wiki">卡牌WIKI</a>】的功能和外观，现在魔王、魔神可以正确地显示，也能通过技能来搜索卡牌了，感谢<x>虚梦杀</x>的建议</li>
                    </ul></li>
                    <li>2015-09-24: 添加新卡<c>黄金毒龙</c>、<c>永夜真祖</c>、<c>水母精灵</c>、<c>王国厨师长</c>、<c>鬼符咒术师</c>、<c>丰饶之神</c></li>
                    <li>2015-09-10: <ul>
                        <li>对【<a href="#boss-battle">魔神战</a>】的结果显示方法进行一些微调，感谢<x>主公摇头怕怕</x>的建议</li>
                        <li>添加新卡<c>月樱公主</c>，感谢<x>咬起来喀嚓喀嚓</x>的提醒</li>
                    ...
                    <li>2015-09-03: <ul>
                        <li>添加新卡<c>处女座</c>，感谢<x>戒不了你IQ</x>的提醒</li>
                        <li>添加新卡<c>僵尸新娘</c>，感谢<x>MikuFanBunz</x>的提醒</li>
                        <li>添加新卡<c>山羊人前锋</c>，感谢<x>珊0殇 </x>的提醒</li>
                    </ul></li>
                    <li>2015-08-29: <ul>
                        <li>添加新卡<c>鬼灵搜索师</c>，感谢<x>咬起来喀嚓喀嚓</x>的提醒</li>
                        <li>添加新卡<c>不屈之灵</c></li>
                    </ul></li>
                    <li>2015-08-27: 添加新卡<c>雪月花</c></li>
                    <li>2015-08-15: <ul>
                    ...
                    <li>2015-08-14: 添加新卡<c>残翼羽神</c>、<c>无限之神</c>、<c>银河观测者</c>，感谢<x>咬起来喀嚓喀嚓</x>和<x>heixuanfeng54</x>的提醒</li>
                    <li>2015-08-04: <ul>
                    ...
                    <li>2015-08-02: <ul>
                        ...
                        <li>添加新卡<c>精灵投掷者</c>、<c>精灵重甲弓手</c>、<c>失魂哥布林</c>，感谢<x>虚梦杀</x>提供资料</li>
                    </ul></li>
                    <li>2015-08-01: <ul>
                    ...
                    <li>2015-07-28: <ul>
                        <li>修复<c>大毒汁之王</c>和<c>谎言之神</c>的技能BUG，感谢<x>saxitong</x>, <x>l793366568</x>, <x>平平一指</x>, <x>仰落灬</x>, <x>裂空座2012</x>报告BUG</li>
                    ...
                    <li>2015-07-26: <ul>
                        ...
                        <li>添加新卡<c>荆棘妖姬</c>、<c>恶魔傀儡</c>、<c>魔导骑兵</c>、<c>复仇铠甲</c>，感谢<x>We_Yukirin</x>的提醒</li>
                        <li>添加新卡<c>吞噬守卫者</c>，感谢<x>虚梦杀</x>的提醒</li>
                        <li>修复莉莉丝战不检查卡组的BUG，感谢<x>wswc2</x>发现BUG</li>
                        <li>修复一个【奋战】的计算BUG，感谢<x>brunoweiyang</x>发现BUG</li>
                    </ul></li>
                    <li>2015-07-25: <ul>
                        <li>添加新卡<c>大毒汁之王</c>，感谢<x>l793366568</x>提供资料</li>
                        <li>添加新卡<c>魔装机神</c>，感谢<x>仰落灬</x>提供资料</li>
                        <li>添加新卡<c>希望之壳</c>，感谢<x>We_Yukirin</x>提供资料</li>
                    </ul></li>
                    <li>2015-07-17: 添加新卡<c>九命猫神</c>，感谢<x>艾弗森张伯伦</x>提供资料</li>
                    <li>2015-07-11: <ul>
                        <li>添加新卡<c>七彩之影</c>、<c>巨蟹座</c>，感謝<x>竞彩小菜鸟</x>, <x>華麗麗摔倒</x>, <x>0蝶舞九天0</x>的提醒</li>
                        <li>修复【破魔手】技能的伤害BUG，感谢<x>裂空座2012</x>发现</li>
                        <li><c>血祭恶魔</c>、<c>血炼巫妖</c>、<c>血瞳魔剑师</c>、<c>血色骑士</c>四张卡的旧卡名称现在也可以使用了，感谢<x>akb48zwy</x>的建议</li>
                    </ul></li>
                    <li>2015-06-20: <ul>
                        <li>添加新卡<c>命运占卜师</c></li>
                    ...
                    <li>2015-06-13: <ul>
                        <li>添加新卡<c>狡诈邪神</c>，感谢<x>dl8o8lb</x>, <x>希埃尔之遗物</x></li>
                        <li>修改魔神名，不再用[新]、[旧]前缀，而用魔神具有代表性技能作前缀，比如<c>送还复仇女神</c>。感谢<x>wolfeopen</x>, <x>ggmmhaha</x>, <x>eudfhgtdr</x></li>
                    </ul></li>
                    <li>2015-06-07: <ul>
                        <li>添加新卡<c>彼岸使者</c>，感谢<x>real11inter</x>, <x>傲娇王孙</x>, <x>957065547</x>的提供情报</li>
                    </ul></li>
                    <li>2015-06-05: <ul>
                        <li>添加新卡<c>双子座</c></li>
                        <li>添加新卡<c>机械魔偶</c>，感谢<x>青的魔法使</x></li>
                    </ul></li>
                    <li>2015-05-23: <ul>
                        <li>添加新技能【闪光弹】、【致盲】，感谢<x>947053627</x>, <x>曾经的雪寂</x>, <x>裘可拉kiss</x>, <x>raffinat</x>, <x>灼眼阿卡林</x>, <x>司徒不想</x>, <x>唯一心3</x>, <x>为何打后</x>的帮助
                        <li>添加新卡<c>堕落修女</c>、<c>金牛座</c></li>
                    </ul></li>
                    <li>2015-05-21: 添加新卡<c>百花女神</c>、<c>深渊吞噬者</c>、<c>野猪人卫士</c></li>
                    <li>2015-05-20: 添加新卡<c>恐怖失血者</c>，感謝<x>lrxlrx207</x></li>
                    <li>2015-05-17: 添加新技能【燕返】，添加新卡<c>欲望惩罚者</c>、<c>月镰杀手</c>，感谢<x>real11inter</x>, <x>bendlueng99</x>, <x>千下</x>, <x>jiye30</x>的帮助</li>
                    <li>2015-05-10: <ul>
                        <li>添加新卡<c>羽蛇神</c>、<c>屠龙勇士</c></li>
                    ...
                    <li>2015-04-25: <ul>
                        <li>添加新卡<c>投掷巨人</c>，感谢<x>晶蓝矢秩</x>提醒</li>
                        <li>添加新卡<c>白羊座</c>，感谢<x>不小心到了这里</x>, <x>联邦兽王</x>, <x>lg5zh</x>, <x>hatachaing</x>, <x>毓飞扬</x>, <x>li87684765</x>, <x>real11inter</x>的帮助</li>
                    </ul></li>
                    <li>2015-03-28: 添加新卡<c>元素之灵</c>，关于同调技能尚不完善，欢迎大家踊跃回答问题补充技能细节。感谢<x>不渝小溪</x>, <x>老子衿</x>, <x>brunoweiyang</x>, <x>裘可拉kiss</x>的帮助</li>
                    <li>2015-03-26: 添加新卡<c>精灵王亡灵</c></li>
                    ...
                    <li>2015-02-27：<ul>
                        <li>添加新卡<c>战场舞姬</c></li>
                        <li>修复一个<c>复活节兔女郎</c>的BUG, 感谢<x>傲娇王孙</x>报告BUG</li>
                    </ul></li>
                    <li>2015-02-15: <ul>
                        <li>添加新卡：<c>炎魔</c>、<c>战意斗神</c>、<c>大毒汁怪</c></li>
                        <li>添加16图的地图战模拟</li>
                        <li>为了方便优化卡组，现在可以使用<b>凤凰*0</b>这样的表示法了</li>
                    </ul></li>
                    <li>2015-02-14: <ul>
                        <li>添加新卡：<c>爱神</c>、<c>圣泉之灵</c></li>
                    ...
                    <li>2015-02-13: <ul>
                        ...
                        <li>添加新卡：<c>战场扫荡者</c>、<c>魔幻人偶师</c></li>
                    </ul></li>
                    <li>2015-01-31: 旧魔神改成第一版的魔神，以便和美服马服对应</li>
                    <li>2015-01-30: 修复一个【鲜血盛宴】极端情况下的BUG</li>
                    <li>2015-01-23: <ul>
                        <li>修复<c>圣堂执政官</c>的数据BUG，感谢<x>血色☆星辰</x>报告BUG</li>
                        <li>添加<c>邪魔屠夫</c>卡图，感谢<x>susss222</x>提供数据</li>
                        <li>修正【森林沐浴】技能结算方法，感谢<x>小歆时代</x>提供的大量实测数据</li>
                    </ul></li>
                    <li>2015-01-21: <ul>
                        <li>修复数据BUG - <c>圆月魔女</c>3技能由【净化】改成【神性祈求】，感谢<x>susss222</x>报告BUG</li>
                        <li>添加<c>巨石投石车手</c>的卡图</li>
                        <li>修复【献祭】不发动死契技能的BUG，感谢<x>千下</x>报告BUG</li>
                    </ul></li>
                    <li>2015-01-20: <ul>
                        <li>修复【大地之盾】的BUG，感谢<x>catree1988</x>, <x>qazqwe240</x>报告BUG</li>
                        <li>添加<c>咒怨稻草人</c>的卡图，感谢<x>qazqwe240</x>提供图片</li>
                        <li>添加新卡<c>赤面天狗</c></li>
                    </ul></li>
                    <li>2015-01-17: <ul>
                        <li>新增莉莉丝活动卡<c>半人鱼恶魔</c>、<c>圣灵大祭司</c>、<c>圣城卫士</c>、<c>咒怨稻草人</c>、<c>邪魔屠夫</c>、<c>巨石投石车手</c>，感谢<x>绯弹亚丝娜</x>, <x>yezhihuib</x>, <x>程love翔</x>, <x>susss222</x>提供数据</li>
                        <li>恢复了旧魔神的模拟，方便马服美服用户</li>
                        <li>添加新卡：<c>世界杯·美国</c>、<c>世界杯·法国</c>、<c>世界杯·德国</c>、<c>世界杯·韩日</c>、<c>世界杯·南非</c>、<c>世界杯·巴西</c>，感谢<x>程love翔</x>提供数据</li>
                    ...
                    <li>2015-01-14: <ul>
                        ...
                        <li>修复<c>亡灵守护神</c>数据BUG，感谢<x>悪丿娘殿下</x>报告BUG</li>
                    </ul></li>
                    ...
                    <li>2015-01-09: 添加新卡<c>驭灵法师</c>，感谢<x>均卡</x>提供数据</li>
                    <li>2015-01-08: <ul>
                        <li>添加新卡<c>圣泉元神</c></li>
                    ...
                    <li>2015-01-06: 添加新卡<c>黄金金属巨龙</c>，感谢<x>雪拾玖</x>提供数据</li>
                    <li>2015-01-04: <ul>
                        <li>添加新卡<c>均衡女神</c>，感谢<x>1243712047</x>, <x>快到碗里来mys</x>提供信息</li>
                        <li>添加新技能【死亡印记】，感谢<x>susss222</x>提供信息</li>
                        <li>添加新卡<c>灵俑暗杀者</c>、<c>鬣蜥人密探</c>、<c>贪婪之心</c></li>
                    </ul></li>
                    <li>2015-01-03: <ul>
                        <li>添加新卡<c>铁血剑豪</c>、<c>铸造大师</c>、<c>巨龙剑士</c>、<c>重装半鹿人</c>、<c>太古魔狼</c></li>
                        ...
                        <li>修复<c>峦龙</c>的种族错误，感谢<x>出发1985</x>报告BUG</li>
                        <li>添加符文【神祈】，感谢<x>出发1985</x>提供信息</li>
                    </ul></li>
                    <li>2015-01-02: <ul>
                        <li>修复<c>陨星魔法使</c>召唤时候会null错误的BUG，感谢<x>为何打后</x>报告BUG</li>
                        <li>修复召唤物死亡时秽土会尝试转生的BUG，感谢<x>susss222</x>报告BUG</li>
                        <li>添加符文【玄石】、【龙吟】，感谢<x>麋鹿吉特</x>, <x>susss222</x>提供信息</li>
                    </ul></li>
                    <li>2015-01-01: <ul>
                        <li>添加新卡<c>湿地黏龙</c>蛮荒四星</li>
                        <li>添加新卡<c>怒雪咆哮</c>蛮荒五星，感谢<x>麋鹿吉特</x>提供数据。</li>
                        <li>添加新技能【大地之盾】，感谢<x>雪拾玖</x>, <x>zx16792007</x>, <x>快到碗里来mys</x>, <x>为何打后</x>, <x>暗之影5</x>提供信息</li>
                        <li>完成【复仇女神】魔神、【万蛛之后】魔神，感谢<x>麋鹿吉特</x>提供数据。</li>
                        <li>添加新卡<c>血色骑士</c>王国四星、<c>无尽噩梦</c>地狱五星</li>
                    </ul></li>
                    <li>2014-12-31: 添加各级【莉莉丝】、<c>星夜女神</c>森林五星，完成【噩梦之主】魔神</li>
                    <li>2014-12-30: 添加<c>陨星魔法师</c>王国五星、<c>梦境耳语者</c>森林四星、<c>乌鸦人长老</c>蛮荒四星、<c>谎言之神</c>地狱五星、<c>瓦尔基里英灵</c>王国四星</li>
                    <li>2014-12-28: 添加<c>骨灵巫女</c>地狱五星、<c>月蚀兽</c>地狱五星</li>
                    <li>2014-12-27: 添加<c>逐月饿狼</c>地狱五星、<c>蝗虫公爵</c>地狱五星、<c>镜魔</c>地狱四星、<c>蝠王恶灵</c>地狱四星</li>
                    <li>2014-12-26: 添加<c>死域军神</c>地狱五星、<c>圆月魔女</c>地狱五星、<c>魅灵吞噬者</c>地狱四星、<c>峦龙</c>地狱五星</li>
                    <li>2014-12-25: 添加<c>暗影牧师</c>地狱四星、<c>地狱炎车手</c>地狱四星、<c>炼狱玩具熊</c>地狱四星、<c>血妖舞女</c>地狱四星</li>
                    <li>2014-12-24: 添加<c>逐日凶狼</c>蛮荒五星、<c>刃羽钢隼</c>蛮荒四星、<c>摩羯大祭司</c>蛮荒五星、<c>荒野巫医</c>蛮荒四星</li>
                    <li>2014-12-23: 添加<c>兽灵使者</c>蛮荒四星、<c>盾墙巨兽</c>蛮荒四星、<c>狂野雷电</c>蛮荒四星、<c>野猪人萨满</c>蛮荒四星</li>
                    <li>2014-12-22: 添加<c>浅海水兽</c>蛮荒四星、<c>蛮族酋长</c>蛮荒四星、<c>神谕火狐</c>蛮荒五星、<c>山羊人先锋</c>蛮荒四星</li>
                    <li>2014-12-21: 添加<c>幸运星贤者</c>森林四星、<c>破晓守卫</c>森林五星、<c>洞察之鹰</c>森林四星、<c>人马大贤者</c>森林四星</li>
                    <li>2014-12-20: 添加<c>浮云青鸟</c>森林五星、<c>尖啸曼陀罗</c>森林四星、<c>雷雕之魂</c>森林五星、<c>星辰之蝶</c>森林四星</li> 
                    <li>2014-12-19: 添加<c>圣炎魔导师</c>王国五星、<c>红月女仆</c>王国三星、<c>飞行器机师</c>王国四星、<c>琴舞之风</c>森林四星</li>
                    <li>2014-12-18: 添加<c>幻术舞姬</c>王国四星、<c>钢铁巨神兵</c>王国五星、<c>鬼斩破</c>王国四星、<c>星辰主宰</c>王国五星</li>
                    <li>2014-12-17: 添加<c>死兆星</c>地狱五星、<c>东方幻术师</c>王国四星、<c>大图书馆长</c>王国四星、<c>重甲冲锋兵</c>王国四星</li>
                    <li>2014-02-06: 添加<c>浴火龙女</c>王国五星</li>
                    ...
                    <li>2014-01-15:<ul>
                        <li>新卡加入 - <c>海军水手</c>王国三星</li>
                        <li>数据修复 - <c>世界树之灵</c>10级COST修正为16。多谢<a data-type="user">长天渔歌</a>提供情报。</li>
                        <li>数据修复 - <c>恐惧之王</c>15级COST修正为17。多谢<a data-type="user">高端大气上档次</a>提供情报。</li>
                        </ul>
                    </li>
                    <li>2014-01-12: 新功能 - 增加<a href="#test-rp">人品测试房</a>。
                    <li>2014-01-11: 数据修复 - <c>世界树之灵</c>15级COST修正为17。多谢<a data-type="user">里根</a>和<a data-type="user">乌鸦</a>提供情报。</li>
                    <li>2014-01-10:<ul>
                    ...
                    <li>2014-01-05:<ul>
                        ...
                        <li>BUG修复 - 现在<c>九头妖蛇</c>在被<c>复活节兔女郎</c>复活后能正确的献祭<c>复活节兔女郎</c>，感谢<a data-type="user">老头是废柴</a>等朋友提供情报。</li>
                        <li>优化 - 魔神战的文字战斗现在会在首行显示对魔神造成的伤害，不必再翻页查看。</li>
                        </ul>
                    </li>
                    <li>2014-01-04: 添加新卡<c>海军司令</c>王国五星，感谢<a data-type="user">我就是那么叼</a>和<a data-type="user">寒风</a>提供情报，感谢<a data-type="user">上行之风</a>发现BUG。</li>
                    <li>2013-12-30: 添加新卡<c>天界守护者</c>王国五星，感谢<a data-type="user">轩</a>和<a data-type="user">UII</a>提供情报。</li>
                    <li>2013-12-25: 更新5张新卡，感谢<a data-type="user">a272295516</a>等朋友热情提供情报。
                        <ul><li>森林：<c>蒲公英仙子</c></li><li>蛮荒：<c>荒漠仙人掌</c> <c>熊人巫医</c> <c>半狮人武士</c> <c>齐天美猴王</c></li></ul>
                    </li>
                    ...
                    <li>2013-12-03: 魔神更新以及BUG修复
                        <ul>
                            ...
                            <li>修复<c>虚空假面</c>的攻击力BUG，感谢<a data-type="user">slbtsbc</a>和<b>守望月磐</b>提供情报</li>
                            <li>修复<c>魔法协会长</c>复活带【封印】或【背刺】卡牌时候的BUG，感谢<a data-type="user">a0026881</a>提供情报</li>
                        </ul>
                    </li>
                    <li>2013-11-30: BUG修复
                        <ul>
                            <li>修复【横扫】触发额外【裂伤】的BUG，感谢<a data-type="user">沸腾的冰红茶</a>提供情报</li>
                            <li>修复<c>世界树之灵</c>【神圣守护】的BUG，感谢<a data-type="user">hejiangting8</a>提供情报</li>
                            <li>修复<c>世界树之灵</c>COST的BUG，感谢<b>IP为221.*.*.158的朋友</b>提供情报</li>
                            <li>更新<c>骸骨大将</c>的第二技能为【[死契]暴风雪6】，感谢<b>IP为112.*.*.134的朋友</b>提供情报</li>
                        </ul>
                    </li>
                    ...
                    <li>2013-11-27: 修复几个BUG
                        <ul>
                            <li><c>精灵女王</c>的COST从19改为17，15级COST改为19（感谢吧友<a data-type="user">uiiysss1</a>提供情报）</li>
                            <li>修复地图战中<b>无符文</b>的条件判断错误（感谢吧友<a data-type="user">勿忘干将</a>和<a data-type="user">ycphoenix</a>提供情报）</li>
                            <li>修复<c>魔法协会长</c>总是复活最后死亡的卡的BUG（感谢吧友<a data-type="user">PandaGM</a>提供情报）</li>
                            <li>新加的一些卡片的数据都来源于魔卡WIKI，但是这次WIKI上的COST数值都很诡异，多数卡10级和15级的COST没有区别，可能有错，希望大家一起帮忙排查</li>
                        </ul>
                    </li>
                    <li>2013-11-25: 添加17张新卡
                        <ul>
                            <li>王国：<c>血瞳魔剑师</c> <c>王城巡逻犬</c> <c>魔能巨石像</c> <c>科学怪人</c> <c>驯鹰射手</c></li>
                            <li>森林：<c>复仇血精灵</c> <c>裁决巨石像</c> <c>高等暗精灵</c> <c>梦境女神</c> <c>精灵女王</c></li>
                            <li>蛮荒：<c>仙狐巫女</c> <c>尖牙捕食者</c> <c>冰雪巨人</c> <c>龙角将军</c></li>
                            <li>地狱：<c>赤红地狱战马</c> <c>骸骨大将</c> <c>末日预言师</c></li>
                        </ul>
                    </li>
                </ul>
            </div>
