...
<body>
    ...
    <div data-role="collapsible" data-collapsed="false" data-content-theme="d" style="WIDTH: 500px">
        <h3>卡组</h3>
        <div>
                                    <div id="card-filter">
                            ...
                            <div>
            <ul data-role="listview" data-mini="true" style="WIDTH: 100%">
                <li data-mini="true" data-wrapperels="div">
                    <table style="WIDTH: 100%">
                    <tr>
                        <td><a href="#ppp1" data-rel="popup" data-mini="true">城镇弓箭手</a></td>
                        <td>
                            <select data-mini="true">
                                <option>LV 0</option>
                                <option>LV 1</option>
                        ...
                        <td>
                        <a href="#" data-role="button" data-inline="true" data-mini="true" data-icon="plus" data-iconpos="notext"></a>
                    </tr>
                    </table>
                </li>
    ...
    <div data-role="popup" id="ppp1">
        <a data-role="button" data-rel="popup" href="#ppp2">Open Another Popup</a>
    </div>
