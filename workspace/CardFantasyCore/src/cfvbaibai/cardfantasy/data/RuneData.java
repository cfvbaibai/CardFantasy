...
public enum RuneData {
    ...
    岩壁(RuneClass.GROUND, 4, FeatureType.格挡, 5, 1, 3, Growth.RUNE, RuneActivator.myField(1, Race.蛮荒)),
    深渊(RuneClass.GROUND, 4, FeatureType.毒雾, 5, 1, 3, Growth.RUNE, RuneActivator.enemyGrave(1, Race.王国)),
