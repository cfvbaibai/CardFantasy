...
public enum FeatureType {
    ...
    森林之力("31121", 25, SkillTag.基础攻击加成),
    地狱之力("31140", 25, SkillTag.基础攻击加成),
    蛮荒之力("31141", 25, SkillTag.基础攻击加成),
    王国之力("30932", 25, SkillTag.基础攻击加成),
    本源之力("30938", 20, SkillTag.基础攻击加成),
    ...
    召唤女神侍者("80191", 0, 0, SkillTag.不可洗炼),
    召唤树人守护者("", 0, 0, SkillTag.不可洗炼),

    军团王国之力("", 0, 3, SkillTag.永久, SkillTag.原始攻击加成, SkillTag.不可洗炼),
    军团森林之力("", 0, 3, SkillTag.永久, SkillTag.原始攻击加成, SkillTag.不可洗炼),
    军团蛮荒之力("", 0, 3, SkillTag.永久, SkillTag.原始攻击加成, SkillTag.不可洗炼),
