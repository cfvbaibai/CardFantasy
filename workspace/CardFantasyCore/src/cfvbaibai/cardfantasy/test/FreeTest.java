...
public class FreeTest extends PveEngineTest {
    ...
    private static GameResultStat massivePlay10v10(String card1, String card2, int level) {
        return play(PlayerBuilder.build("英雄" + card1, level, "C" + card1 + "-10*10"),
                PlayerBuilder.build("英雄" + card2, level, "C" + card2 + "-10*10"), 1000);
    }

    private static GameResultStat massivePlay1v1(String card1, String card2, int level) {
        return play(PlayerBuilder.build("英雄" + card1, level, "C" + card1 + "-10*1"),
                PlayerBuilder.build("英雄" + card2, level, "C" + card2 + "-10*1"), 1000);
    }

    private static GameResultStat massivePlay1v1Lv15(String card1, String card2, int level) {
        return play(PlayerBuilder.build("英雄" + card1, level, "C" + card1 + "-15"),
                PlayerBuilder.build("英雄" + card2, level, "C" + card2 + "-10"), 1000);
    }

    private static GameResultStat massivePlay10v10Lv15(String card1, String card2, int level) {
        return play(PlayerBuilder.build("英雄" + card1, level, "C" + card1 + "-15*10"),
                PlayerBuilder.build("英雄" + card2, level, "C" + card2 + "-10*10"), 1000);
    }
    ...
    public void 王国最强vs森林最强_1000() {
        for (int i = 6; i < 10; ++i) {
            ...
            PlayerInfo p1 = PlayerBuilder.build("王国英雄", i * 10, "C光明之龙-10*10", "R寒伤-4", "R清泉-4", "R冰封-4");// ,
                                                                                                          // "R怒涛-4");
            PlayerInfo p2 = PlayerBuilder.build("森林英雄", i * 10, "C金属巨龙-10*10", "R雷盾-4", "R春风-4", "R轻灵-4");// ,
                                                                                                          // "R淬炼-4");
    ...
    public void 王国最强vs王森最强_1000() {
        for (int i = 6; i < 10; ++i) {
            System.out.println("Level: " + (i * 10));
            PlayerInfo p1 = PlayerBuilder.build("王国英雄", i * 10, "C光明之龙-10*10", "R寒伤-4", "R清泉-4", "R冰封-4", "R怒涛-4");
            PlayerInfo p2 = PlayerBuilder.build("王森英雄", i * 10, "C金属巨龙-10*5", "C降临天使-10*5", "R雷盾-4", "R春风-4", "R冰封-4",
                    "R清泉-4");
    ...
    public void 王国最强vs蛮荒最强_1000() {
        for (int i = 6; i < 10; ++i) {
            System.out.println("Level: " + (i * 10));
            PlayerInfo p1 = PlayerBuilder.build("王国英雄", i * 10, "C光明之龙-10*10", "R寒伤-4", "R清泉-4", "R冰封-4", "R洞察-4");
            PlayerInfo p2 = PlayerBuilder.build("蛮荒英雄", i * 10, "C雷兽-10*10", "R岩壁-4", "R赤谷-4", "R飞岩-4", "R秽土-4");
    ...
    public void 转生一刀vs十五剑圣_1000() {
        for (int i = 6; i < 10; ++i) {
            System.out.println("Level: " + (i * 10));
            PlayerInfo p1 = PlayerBuilder.build("一刀英雄", i * 10, "C转生堕落精灵-15*10", "R灼魂-4", "R灭世-4", "R淬炼-4", "R飓风-4");
            PlayerInfo p2 = PlayerBuilder.build("剑圣英雄", i * 10, "C大剑圣-15*10", "R永冻-4", "R冰封-4", "R清泉-4", "R寒伤-4");
            showStat(play(p1, p2, 1000));
        }
    }
    ...
    public void 光龙vs树人_1000() {
        for (int i = 6; i < 10; ++i) {
            System.out.println("Level: " + (i * 10));
            PlayerInfo p1 = PlayerBuilder.build("光龙英雄", i * 10, "C光明之龙-10*10", "R冰封-4", "R清泉-4", "R寒伤-4", "R永冻-4");
            PlayerInfo p2 = PlayerBuilder.build("树人英雄", i * 10, "C霜雪树人-10*6", "C树人祭司-10*4", "R雷盾-4", "R春风-4", "R轻灵-4");
            showStat(play(p1, p2, 1000));
        }
    }
    ...
    public void 光龙vs大象_1000() {
        for (int i = 6; i < 10; ++i) {
            System.out.println("Level: " + (i * 10));
            PlayerInfo p1 = PlayerBuilder.build("光龙英雄", i * 10, "C光明之龙-10*10", "R冰封-4", "R清泉-4", "R飓风-4", "R永冻-4");
            PlayerInfo p2 = PlayerBuilder.build("大象英雄", i * 10, "C战斗猛犸象-10*10", "R赤谷-4", "R飞岩-4", "R秽土-4", "R怒涛-4");
            showStat(play(p2, p1, 1000));
        }
    }
    ...
    @Test
    public void 光龙vs大象() {
        PlayerInfo p1 = PlayerBuilder.build("光龙英雄", 90, "C光明之龙-10*10", "R冰封-4", "R清泉-4", "R飓风-4", "R永冻-4");
        PlayerInfo p2 = PlayerBuilder.build("大象英雄", 90, "C战斗猛犸象-10*10", "R赤谷-4", "R飞岩-4", "R秽土-4", "R怒涛-4");
        TestGameBuilder.play(p1, p2);
    }

    @Test
    public void 天使vs蜘蛛() {
        PlayerInfo p1 = PlayerBuilder.build("天使英雄", 90, "C降临天使-10*10");
        PlayerInfo p2 = PlayerBuilder.build("蜘蛛英雄", 90, "C蜘蛛人女王-10*10");
        showStat(play(p1, p2, 1000));
        showStat(play(p2, p1, 1000));
    }
    ...
    public void 竞技场测试1() {
        PlayerInfo p1 = PlayerBuilder.build("我方英雄", 74, "C金属巨龙-10*4", "C恐惧之王-10*4", "C灵魂收割者-10*2", "R雷盾-4", "R雷狱-4",
                "R灼魂-4", "R绝杀-4");
        PlayerInfo p2 = PlayerBuilder.build("敌方英雄", 84, "C金属巨龙-10*4", "C降临天使-10*6", "R冰封-4", "R清泉-4", "R雷盾-4", "R永冻-4");
        showStat(play(p1, p2, 1000));
        showStat(play(p2, p1, 1000));
        PlayerInfo p3 = PlayerBuilder.build("敌方英雄", 84, "C金属巨龙-10*5", "C降临天使-10*5", "R冰封-4", "R清泉-4", "R雷盾-4", "R轻灵-4");
    ...
    @Test
    public void 竞技场测试2() {
        PlayerInfo p0 = PlayerBuilder.build("敌方英雄", 75, "C金属巨龙-10*5", "C降临天使-10*5", "R冰封-4", "R清泉-4", "R雷盾-4", "R轻灵-4");
        PlayerInfo p1 = PlayerBuilder.build("我方英雄", 75, "C光明之龙-10*2", "C降临天使-10*2", "C魔法协会长-10", "C灵魂收割者-10*2",
                "C金属巨龙-10*3", "R雷盾-4", "R清泉-4", "R永冻-4", "R冰封-4");
        showStat(play(p0, p1, 1000));
        showStat(play(p1, p0, 1000));
        PlayerInfo p2 = PlayerBuilder.build("我方英雄", 75, "C光明之龙-10*2", "C降临天使-10*2", "C魔法协会长-10", "C灵魂收割者-10",
                "C恐惧之王-10", "C金属巨龙-10*3", "R雷盾-4", "R清泉-4", "R永冻-4", "R冰封-4");
        showStat(play(p0, p2, 1000));
        showStat(play(p2, p0, 1000));
        PlayerInfo p3 = PlayerBuilder.build("我方英雄", 75, "C光明之龙-10", "C降临天使-10*3", "C魔法协会长-10", "C灵魂收割者-10*2",
                "C金属巨龙-10*3", "R雷盾-4", "R清泉-4", "R永冻-4", "R冰封-4");
        showStat(play(p0, p3, 1000));
        showStat(play(p3, p0, 1000));
        PlayerInfo p4 = PlayerBuilder.build("我方英雄", 75, "C光明之龙-10", "C降临天使-10*3", "C魔法协会长-10", "C灵魂收割者-10", "C恐惧之王-10",
                "C金属巨龙-10*3", "R雷盾-4", "R清泉-4", "R永冻-4", "R冰封-4");
    ...
    @Test
    public void 竞技场测试3() {
        PlayerInfo p0 = PlayerBuilder.build("敌方英雄", 75, "C金属巨龙-10*6", "C降临天使-10*4", "R冰封-4", "R清泉-4", "R雷盾-4", "R永冻-4");
        PlayerInfo p1 = PlayerBuilder.build("我方英雄", 75, "C金属巨龙-10*3", "C复活节兔女郎-10*2", "C雷兽-10*3", "C震源岩蟾-10*1",
                "C羽翼化蛇-10*1", "R雷盾-4", "R春风-4", "R岩壁-4", "R赤谷-4");
        showStat(play(p0, p1, 1000));
        showStat(play(p1, p0, 1000));
        PlayerInfo p2 = PlayerBuilder.build("我方英雄", 75, "C金属巨龙-10*3", "C复活节兔女郎-10*1", "C雷兽-10*4", "C震源岩蟾-10*1",
                "C羽翼化蛇-10*1", "R雷盾-4", "R春风-4", "R岩壁-4", "R赤谷-4");
        showStat(play(p0, p2, 1000));
        showStat(play(p2, p0, 1000));
        PlayerInfo p3 = PlayerBuilder.build("我方英雄", 75, "C金属巨龙-10*4", "C雷兽-10*4", "C震源岩蟾-10*1", "C羽翼化蛇-10*1", "R雷盾-4",
                "R春风-4", "R岩壁-4", "R赤谷-4");
        showStat(play(p0, p3, 1000));
        showStat(play(p3, p0, 1000));
        PlayerInfo p4 = PlayerBuilder.build("我方英雄", 75, "C金属巨龙-10*4", "C复活节兔女郎-10*1", "C雷兽-10*4", "C羽翼化蛇-10*1",
    ...
    @Test
    public void 竞技场测试4() {
        PlayerInfo p0 = PlayerBuilder.build("阵容1", 75, "C金属巨龙-10*5", "C降临天使-10*5", "R冰封-4", "R清泉-4", "R雷盾-4", "R雷狱-4");
        PlayerInfo p1 = PlayerBuilder.build("阵容2", 75, "C不动猛犸-15*10", "R秽土-4", "R石林-4", "R淬炼-4", "R赤谷-4");
        PlayerInfo p2 = PlayerBuilder.build("阵容3", 75, "C降临天使-10*5", "C灵魂收割者-10*2", "C亡灵守护神-10", "C恐惧之王-10*2", "R冰封-4",
                "R清泉-4", "R灼魂-4", "R绝杀-4");
        PlayerInfo p3 = PlayerBuilder.build("阵容4", 75, "C不动猛犸-15*4", "C穿刺蛤蟆-10*2", "C恐惧之王-10*3", "C亡灵守护神-10", "R石林-4",
                "R灼魂-4", "R绝杀-4", "R赤谷-4");
        showStat(play(p0, p1, 1000));
        showStat(play(p0, p2, 1000));
        showStat(play(p0, p3, 1000));
    ...
    @Test
    public void 竞技场测试5() {
        PlayerInfo p0 = PlayerBuilder.build("最强王森", 75, "C金属巨龙-10*5", "C降临天使-10*5", "R冰封-4", "R清泉-4", "R雷盾-4", "R永冻-4");
        PlayerInfo p1 = PlayerBuilder.build("船夫队", 75, "C冥河船夫-10","C灵魂收割者-10*3", "C魔法协会长-10", "C降临天使-10*5",
                "R冰封-4", "R清泉-4", "R永冻-4", "R灼魂-4");
        PlayerInfo p2 = PlayerBuilder.build("老头战神1队", 75, "C魔法协会长-10", "C战神-10*2", "C降临天使-10*3", "C灵魂收割者-10*4",
                "R冰封-4", "R清泉-4", "R永冻-4", "R灼魂-4");
        PlayerInfo p3 = PlayerBuilder.build("老头战神2队", 75, "C魔法协会长-10", "C战神-10*2", "C降临天使-10*3", "C灵魂收割者-10*3", "C冥河船夫-10",
                "R冰封-4", "R清泉-4", "R永冻-4", "R灼魂-4");
        showStat(play(p0, p1, 1000));
        showStat(play(p1, p0, 1000));
        showStat(play(p0, p2, 1000));
    ...
    @Test
    public void 竞技场测试6() {
        PlayerInfo p0 = PlayerBuilder.build("最强王森", 75, "C金属巨龙-10*5", "C降临天使-10*5", "R冰封-4", "R春风-4", "R雷盾-4", "R永冻-4");
        //4雷兽1化蛇3金属2兔子 赤谷岩壁雷盾春风
        PlayerInfo p1 = PlayerBuilder.build("蛮森一队", 75, "C雷兽-10*4", "C羽翼化蛇-10", "C金属巨龙-10*3", "C复活节兔女郎-10*2",
                "R赤谷-4", "R岩壁-4", "R雷盾-4", "R春风-4");
        //2雷兽2毒雾1化蛇3金属2兔子
        PlayerInfo p2 = PlayerBuilder.build("蛮森二队", 75, "C雷兽-10*2", "C毒雾羽龙-10*2", "C羽翼化蛇-10", "C金属巨龙-10*3", "C复活节兔女郎-10*2",
                "R赤谷-4", "R岩壁-4", "R雷盾-4", "R春风-4");
        showStat(play(p0, p1, 1000));
        showStat(play(p1, p0, 1000));
        showStat(play(p0, p2, 1000));
    ...
    public void 竞技场测试7() {
        ...
        PlayerInfo p00 = PlayerBuilder.build("最强蛮森", 75, "C雷兽-10*3", "C毒雾羽龙-10", "C震源岩蟾-10", "C金属巨龙-10*3", "C复活节兔女郎-10*2",
                "R赤谷-4", "R春风-4", "R雷盾-4", "R岩壁-4");
        //4天使，老头，2恐惧，2萝莉，1黑龙，符文灼魂冰封清泉永冻
        PlayerInfo p1 = PlayerBuilder.build("打脸一队", 75, "C降临天使-10*4", "C魔法协会长-10", "C恐惧之王-10*2", "C灵魂收割者-10*2", "C毁灭之龙-10",
                "R灼魂-4", "R冰封-4", "R清泉-4", "R永冻-4");
        //4天使，老头，4恐惧，1黑龙
        PlayerInfo p2 = PlayerBuilder.build("打脸二队", 75, "C降临天使-10*4", "C魔法协会长-10", "C恐惧之王-10*4", "C毁灭之龙-10",
                "R灼魂-4", "R冰封-4", "R清泉-4", "R永冻-4");
        showStat(play(p0, p1, 1000));
        showStat(play(p1, p0, 1000));
        showStat(play(p0, p2, 1000));
    ...
    @Test
    public void 竞技场测试8() {
        PlayerInfo p0 = PlayerBuilder.build("最强王森", 85, "C金属巨龙-10*5", "C降临天使-10*5", "R冰封-4", "R春风-4", "R雷盾-4", "R永冻-4");
        // 金属*1，水源*1，凤凰*2，老头*1， 秘银*1，机械飞龙*1，剑圣*1，萝莉*1，蛤蟆*1, 雷盾，春风，冰封，淬炼
        PlayerInfo p1 = PlayerBuilder.build("阵容1", 85, "C金属巨龙-10", "C水源制造者-10", "C凤凰-10*2", "C魔法协会长-10", "C秘银巨石像-10", "C机械飞龙-10",
                "C大剑圣-10", "C灵魂收割者-10", "C震源岩蟾-10", "R冰封-4", "R春风-4", "R雷盾-4", "R淬炼-4");
        // 金属*1，水源*1，凤凰*2，老头*1， 秘银*1，机械飞龙*1，皇家卫队长*1，萝莉*1，蛤蟆*1, 雷盾，春风，冰封，淬炼
        PlayerInfo p2 = PlayerBuilder.build("阵容2", 85, "C金属巨龙-10", "C水源制造者-10", "C凤凰-10*2", "C魔法协会长-10", "C秘银巨石像-10", "C机械飞龙-10",
                "C皇家卫队将领-10", "C灵魂收割者-10", "C震源岩蟾-10", "R冰封-4", "R春风-4", "R雷盾-4", "R淬炼-4");
        // 金属*1，水源*1，凤凰*2，老头*1， 秘银*1，机械飞龙*1，大主教*1，萝莉*1，蛤蟆*1, 雷盾，春风，冰封，淬炼
        PlayerInfo p3 = PlayerBuilder.build("阵容3", 85, "C金属巨龙-10", "C水源制造者-10", "C凤凰-10*2", "C魔法协会长-10", "C秘银巨石像-10", "C机械飞龙-10",
                "C大主教-10", "C灵魂收割者-10", "C震源岩蟾-10", "R冰封-4", "R春风-4", "R雷盾-4", "R淬炼-4");
        // 金属*1，水源*1，凤凰*2，老头*1， 秘银*1，机械飞龙*1，皇家驯兽师，萝莉*1，蛤蟆*1, 雷盾，春风，冰封，淬炼
        PlayerInfo p4 = PlayerBuilder.build("阵容4", 85, "C金属巨龙-10", "C水源制造者-10", "C凤凰-10*2", "C魔法协会长-10", "C秘银巨石像-10", "C机械飞龙-10",
                "C皇家驯兽师-10", "C灵魂收割者-10", "C震源岩蟾-10", "R冰封-4", "R春风-4", "R雷盾-4", "R淬炼-4");
        // 金属1，水源1,凤凰2，森女1，老头1，萝莉1，蛤蟆1，熊人武士1，猛犸1, 春风雷盾赤谷淬炼
        PlayerInfo p5 = PlayerBuilder.build("阵容5", 85, "C金属巨龙-10", "C水源制造者-10", "C凤凰-10*2", "C森林女神-10", "C魔法协会长-10", 
                "C灵魂收割者-10", "C震源岩蟾-10", "C熊人武士-10", "C战斗猛犸象-10", "R赤谷-4", "R春风-4", "R雷盾-4", "R淬炼-4");
        // 金属1，水源2,凤凰2，老头1，萝莉1，蛤蟆1，熊人武士1，猛犸1, 春风雷盾赤谷淬炼
        PlayerInfo p6 = PlayerBuilder.build("阵容6", 85, "C金属巨龙-10", "C水源制造者-10*2", "C凤凰-10*2", "C魔法协会长-10", 
                "C灵魂收割者-10", "C震源岩蟾-10", "C熊人武士-10", "C战斗猛犸象-10", "R赤谷-4", "R春风-4", "R雷盾-4", "R淬炼-4");
    ...
    public void 幽灵之龙vs恐惧_1000() {
        PlayerInfo p1 = PlayerBuilder.build("英雄幽灵龙", 80, "C幽灵巨龙-10*1");
        PlayerInfo p2 = PlayerBuilder.build("英雄恐惧之王", 80, "C恐惧之王-10*1");
        showStat(play(p2, p1, 1000));
    }
