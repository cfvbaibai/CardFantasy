...
//        }
        ...
        for (CardInfo card : cards) {
            for (SkillUseInfo skillUseInfo : card.getUsableNormalSkills()) {
                if (skillUseInfo.getType() == SkillType.神性祈求 || skillUseInfo.getType() == SkillType.神性祈祷) {
                    ...
                    RemoveDebuffStatus.apply(skillUseInfo, this, card);
                    ...
                    AllFiledAddSkill.apply(this, skillUseInfo, card, skillUseInfo.getAttachedUseInfo1().getSkill());
                        ...
                        || skillUseInfo.getType() == SkillType.蛇蜕之术 || skillUseInfo.getType() == SkillType.破釜沉舟) {
                    AllFiledAddSkill.apply(this, skillUseInfo, card, skillUseInfo.getAttachedUseInfo1().getSkill());
                } else if (skillUseInfo.getType() == SkillType.出云蛇势) {
                    AllFiledAddSkill.apply(this, skillUseInfo, card, skillUseInfo.getAttachedUseInfo1().getSkill());
                    ...
                    AddSidesSkill.apply(this, skillUseInfo, card, skillUseInfo.getAttachedUseInfo1().getSkill());
                } else if (skillUseInfo.getType() == SkillType.神圣领域 || skillUseInfo.getType() == SkillType.反击阵列 || skillUseInfo.getType() == SkillType.正义庇所) {
                    AddSidesSkill.apply(this, skillUseInfo, card, skillUseInfo.getAttachedUseInfo1().getSkill());
                    ...
                    Cooperation.apply(this, skillUseInfo, card, "樱蝶仙子", true);
                        ...
                        || skillUseInfo.getType() == SkillType.摄魂之力 || skillUseInfo.getType() == SkillType.情况紧急) {
    ...
    public void resolvePreAttackSkills(CardInfo attacker, Player defender, int status) throws HeroDieSignal {
        for (SkillUseInfo skillUseInfo : attacker.getUsableNormalSkills()) {
            ...
            if (skillUseInfo.getType() == SkillType.透支 || skillUseInfo.getType() == SkillType.过载 || skillUseInfo.getType() == SkillType.勤学苦练) {
            ...
            } else if (skillUseInfo.getType() == SkillType.灭世之力) {
                GreatFireMagic.apply(skillUseInfo.getSkill(), this, attacker, defender, -1, false);
                ...
                SoulControl.apply(this, skillUseInfo.getAttachedUseInfo2(), attacker, defender);
                    ...
                    || skillUseInfo.getType() == SkillType.闪耀突击 || skillUseInfo.getType() == SkillType.深海之力) {
                ...
                UnderworldCall.apply(this, skillUseInfo.getSkill(), attacker, defender, 3);
                    ...
                    || skillUseInfo.getType() == SkillType.战术性撤退 || skillUseInfo.getType() == SkillType.自毁) {
                ...
                BloodPaint.apply(skillUseInfo.getSkill(), this, attacker, defender, 1);
                    ...
                    skillUseInfo.getType() == SkillType.猎杀之夜 || skillUseInfo.getType() == SkillType.武之圣域) {
                BloodPaint.apply(skillUseInfo.getSkill(), this, attacker, defender, -1);
            } else if (skillUseInfo.getType() == SkillType.天谴 || skillUseInfo.getType() == SkillType.末世术 || skillUseInfo.getType() == SkillType.以逸待劳 || skillUseInfo.getType() == SkillType.天启导言) {
            ...
            } else if (skillUseInfo.getType() == SkillType.灵魂消散 || skillUseInfo.getType() == SkillType.天启导言) {
                ...
                AddSkillOpponent.apply(this, skillUseInfo, attacker, skillUseInfo.getAttachedUseInfo1().getSkill(), 1, defender,false);
            } else if (skillUseInfo.getType() == SkillType.枯萎) {
                AddSkillOpponent.apply(this, skillUseInfo, attacker, skillUseInfo.getAttachedUseInfo1().getSkill(), 2, defender,true);
                ...
                for (SkillUseInfo blockSkillUseInfo : defender.getUsableNormalSkills()) {
                    if (blockSkillUseInfo.getType() == SkillType.魔甲 ||
                        ...
                        result.setDamage(KnightGuardian.apply(this, blockSkillUseInfo.getSkill(), attacker, defender,
                            ...
                            || blockSkillUseInfo.getType() == SkillType.魔法免疫) {
            ...
            if (includeBlocking) {
                if (blockSkillUseInfo.getType() == SkillType.格挡 ||
                    ...
                    result.setDamage(Block.apply(blockSkillUseInfo.getAttachedUseInfo2().getSkill(), this, cardAttacker, defender,
                        ...
                        || blockSkillUseInfo.getType() == SkillType.秘银) {
                    result.setDamage(PhysicalArmor.apply(blockSkillUseInfo.getSkill(), this, cardAttacker, defender,
                        ...
                        || blockSkillUseInfo.getType() == SkillType.优雅之姿 || blockSkillUseInfo.getType() == SkillType.忠肝义胆 ) {
    ...
    public void resolveDeathSkills(EntityInfo killerCard, CardInfo deadCard, Skill cardSkill, OnDamagedResult result) throws HeroDieSignal {
        ...
        if (deadCard.isDead()) {
            for (CardInfo attackFiled : opponent.getField().getAliveCards()) {
                if (attackFiled.containsUsableSkill(SkillType.羽扇虎拳)||attackFiled.containsUsableSkill(SkillType.天罡咒)) {
                    for (SkillUseInfo skillUseInfo : attackFiled.getUsableNormalSkills()) {
                        ...
                        else if(skillUseInfo.getType() == SkillType.天罡咒)
                        {
            ...
            if(deadCardSkillUseInfo.getSkill().isDeathSkill()) {
                ...
                if (deadCardSkillUseInfo.getType() == SkillType.自爆 && !result.unbending) {
                    ...
                    if (cardSkill != null && (cardSkill.getType() == SkillType.侵蚀 || cardSkill.getType() == SkillType.页游吞噬
                            ...
                            || cardSkill.getType() == SkillType.威慑)) {
                        continue;
                    }
        ...
        if (deadCard.getStatus().containsStatus(CardStatusType.祭奠) && deadCard.isDead()) {
            SacrificeBuff.explode(this, deadCard, result, "圣翼白虎","气冲冲仙人掌"," 钢铁蛮牛兽","迅捷豹女");
        }
        if (deadCard.getStatus().containsStatus(CardStatusType.献祭) && deadCard.isDead()) {
        ...
        if (cardSkill == null || !(cardSkill.getType() == SkillType.重整 || cardSkill.getType() == SkillType.不朽岿岩
                ...
                || cardSkill.getType() == SkillType.情况紧急
...
//        }
        ...
        for (SkillUseInfo skillUseInfo : attacker.getUsableNormalSkills()) {
            if (!attacker.isDead()) {
                if (skillUseInfo.getType() == SkillType.穿刺 || skillUseInfo.getType() == SkillType.英雄之敌 || skillUseInfo.getType() == SkillType.头槌破门|| skillUseInfo.getType() == SkillType.横扫千军) {
                    ...
                    Wound.apply(this, skillUseInfo, attackSkill, attacker, defender, normalAttackDamage);
                        ...
                        || skillUseInfo.getType() == SkillType.地煞倾覆) {
            ...
            if (skillUseInfo.getType() == SkillType.武形天火击) {
                if (!defender.isDead() && defender.getStatus().containsStatus(CardStatusType.燃烧)) {
                    ...
                    || skillUseInfo.getType() == SkillType.圣翼骑士 || skillUseInfo.getType() == SkillType.秘术投影) {
    ...
    public void resolveMultAttackSkills(CardInfo attacker, CardInfo defender, Player defenderHero, Skill attackSkill, OnDamagedResult damageResult, boolean firstSkill) throws HeroDieSignal {
        if(attacker.containsUsableSkill(SkillType.高级连击) || attacker.containsUsableSkill(SkillType.狂舞) || attacker.containsUsableSkill(SkillType.正义庇所)
                || attacker.containsUsableSkill(SkillType.夺命骨镰)) {
            for (SkillUseInfo skillUseInfo : attacker.getUsableNormalSkills()) {
                if (!attacker.isDead()) {
                    if (skillUseInfo.getType() == SkillType.高级连击) {
                        ...
                        MultipleAttack.apply(this, skillUseInfo, attacker, defenderHero, attackSkill, firstSkill);
                    } else if (skillUseInfo.getType() == SkillType.正义庇所) {
                        MultipleAttack.applyMultiple(this, skillUseInfo, attacker, defenderHero, attackSkill);
                    }
                }
            }
        }
        ...
        for (SkillEffect effect : card.getEffects()) {
            ...
            if (type == SkillType.圣光 || type == SkillType.要害 || type == SkillType.暗杀 || type == SkillType.污染) {
                ...
                CaeserAttack.remove(this, effect.getCause(), card);
                    ...
                    || type == SkillType.阿拉希血统 || type == SkillType.星座能量清醒 || type == SkillType.夺命骨镰) {
...
//            }
    ...
    public void attackHero(EntityInfo attacker, Player defenderPlayer, Skill cardSkill, int damage)
        ...
        try {
            ...
            if (damage >= 0) {
                ...
                if (!(cardSkill != null && (cardSkill.getType() == SkillType.自动扣血 || cardSkill.getType() == SkillType.羽扇虎拳 || cardSkill.getType() == SkillType.天罡咒 || cardSkill.getType() == SkillType.背水))) {
                ...
                if (remainingDamage > 0) {
                    ...
                    if(!(cardSkill != null && (cardSkill.getType() == SkillType.背水)))
                    {
                        for (CardInfo cardInfo : defenderPlayer.getField().getAliveCards()) {
                            for(SkillUseInfo skillUseInfo:cardInfo.getAllNormalSkills())
                            {
                                if(skillUseInfo.getType() == SkillType.背水)
                                {
                                    int counterDamage = damage*skillUseInfo.getSkill().getImpact()/100;
                                    attackHero(cardInfo,attacker.getOwner(),skillUseInfo.getSkill(),counterDamage);
                                }
                            }
                            break;
                        }
    ...
    public void resolveExtraAttackHeroSkills(CardInfo attacker, Player defenderHero, Boolean firstSkill) throws HeroDieSignal {
        if (!(attacker.containsUsableSkill(SkillType.幻影军团) || attacker.containsUsableSkill(SkillType.高级连击) || attacker.containsUsableSkill(SkillType.狂舞)
                || attacker.containsUsableSkill(SkillType.离魂剑) || attacker.containsUsableSkill(SkillType.幻影奇袭) || attacker.containsUsableSkill(SkillType.圣翼骑士)
                || attacker.containsUsableSkill(SkillType.正义庇所) || attacker.containsUsableSkill(SkillType.秘术投影) || attacker.containsUsableSkill(SkillType.夺命骨镰))) {
            return;
        }
        for (SkillUseInfo skillUseInfo : attacker.getUsableNormalSkills()) {
            if (skillUseInfo.getType() == SkillType.幻影军团 || skillUseInfo.getType() == SkillType.幻影奇袭
                ...
                MultipleAttack.applyMultiple(this, skillUseInfo, attacker, defenderHero, null);
            } else if (skillUseInfo.getType() == SkillType.离魂剑) {
                SoulControlMutiple.apply(this, skillUseInfo, attacker, defenderHero);
            }
        }
    ...
    private int resolveAttackHeroBlockingSkills(EntityInfo attacker, Player defenderPlayer, Skill cardSkill,
        ...
        } else if (cardSkill.getType() == SkillType.自动扣血 || cardSkill.getType() == SkillType.羽扇虎拳 || cardSkill.getType() == SkillType.天罡咒 || cardSkill.getType() == SkillType.背水) {
        ...
        for (SkillUseInfo skillUseInfo : card.getAllUsableSkills()) {
            ...
            if (skillUseInfo.getSkill().isSummonSkill()) {
                ...
                if (skillUseInfo.getType() == SkillType.反噬 || skillUseInfo.getType() == SkillType.恶魔契约) {
                    ...
                    AddSkillOpponent.apply(this, skillUseInfo, card, skillUseInfo.getAttachedUseInfo1().getSkill(), 1, enemy,false);
                    ...
                    AddSkillOpponent.apply(this, skillUseInfo, card, skillUseInfo.getAttachedUseInfo1().getSkill(), 3, enemy,false);
                } else if (skillUseInfo.getType() == SkillType.星座能量力量) {
                    Crumbling.apply(this, skillUseInfo.getSkill(), card, enemy, 1, 1);
                    ...
                    AddSkillOpponent.apply(this, skillUseInfo.getAttachedUseInfo2(), card, skillUseInfo.getAttachedUseInfo2().getAttachedUseInfo1().getSkill(), 1, enemy,false);
...
//                }
                ...
                } else if (skillUseInfo.getType() == SkillType.圣翼骑士 && isSummoning) {
                    if (!card.hasUsed(skillUseInfo)) {
                        Revive.apply(this, skillUseInfo, card);
                        card.setUsed(skillUseInfo);
                    }
    ...
    public void resolveLeaveSkills(CardInfo card) {
        ...
        ImpregnableDefenseHeroBuff.removeSkill(card,this); //铁壁的移除和buff的移除放在一起
    }
    ...
    public boolean resolveIsImmune(CardInfo defender, int type) {
        ...
        if (type == 0) {
            if (defender.containsAllSkill(SkillType.免疫) || defender.containsAllSkill(SkillType.结界立场) || defender.containsAllSkill(SkillType.影青龙)
                    ...
                    || defender.containsAllSkill(SkillType.不灭之魂) || defender.containsAllSkill(SkillType.雷神附体) || defender.containsAllSkill(SkillType.风势)
            ...
            if (defender.containsAllSkill(SkillType.免疫) || defender.containsAllSkill(SkillType.结界立场) || defender.containsAllSkill(SkillType.影青龙)
                    ...
                    || defender.containsAllSkill(SkillType.不灭之魂) || defender.containsAllSkill(SkillType.雷神附体)
                    || defender.containsAllSkill(SkillType.秘术投影) || defender.containsAllSkill(SkillType.风势)
                    || defender.containsAllSkill(SkillType.夺命骨镰) || defender.containsAllSkill(SkillType.醉生梦死)
