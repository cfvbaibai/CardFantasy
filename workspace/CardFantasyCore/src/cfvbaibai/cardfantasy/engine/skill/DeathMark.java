...
public class DeathMark {
    public static void apply(SkillResolver resolver, SkillUseInfo skillUseInfo, CardInfo caster, CardInfo victim) {
        if (victim == null) {
            return;
        }
    ...
    public static void explode(SkillResolver resolver, CardInfo deadCard) throws HeroDieSignal {
        ...
        for (CardStatusItem statusItem : statusItems) {
            ...
            for (CardInfo victim : victims) {
                ...
                resolver.resolveDeathSkills(killer, victim, skill, resolver.applyDamage(victim, damage));
            }
        }
    }
}
