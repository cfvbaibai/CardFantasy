...
public class Summon {
    ...
    public static void applyAndAddSkill(SkillResolver resolver, SkillUseInfo skillUseInfo, CardInfo summoner, SummonType summonType, int summonPicks, Skill addSkill,String... summonedCardsDescs) throws HeroDieSignal {
        if (summoner == null) {
            throw new CardFantasyRuntimeException("summoner should not be null");
        }
        // 镜像不能再次发动镜像
