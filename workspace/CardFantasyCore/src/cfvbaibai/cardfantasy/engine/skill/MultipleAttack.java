...
public final class MultipleAttack {
    public static void apply(SkillResolver resolver, SkillUseInfo attackSkillUseInfo, CardInfo attacker, Player defender, Skill attackSkill, Boolean firstSkill,int attackNumber)
        ...
        int damage = attacker.getCurrentAT()*attackNumber/100;
